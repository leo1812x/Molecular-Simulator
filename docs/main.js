...
require("./index.css");
const lammps = require("./lammps_converter");
const THREE = require("three");
const Addons_js_1 = require("three/examples/jsm/Addons.js");
//!Set up
...
const controls = new Addons_js_1.OrbitControls(exports.camera, exports.renderer.domElement);
